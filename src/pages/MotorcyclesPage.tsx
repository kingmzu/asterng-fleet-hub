    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <div className="relative flex-1">
          ...
          <Input placeholder="Search by registration or make..." value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} className="pl-9" disabled={isLoading} />
        </div>
              ...
              <div key={bike.id} className="rounded-xl border border-border bg-card p-5 shadow-[var(--shadow-card)] transition-shadow hover:shadow-[var(--shadow-elevated)]">
                ...
                <div className="mb-4 space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-foreground">{bike.last_maintenance || 'N/A'}</span>
                  </div>
                </div>
