...
export const useRoles = () => {
  const { data: roles = [], isLoading, isFetching } = useUserRoles();
  ...
  return { roles: list, isAdmin, isManager, isAccountant, isStaff, isRider, canTrackFleet, canManagePricing, isLoading: isLoading || isFetching };
};
